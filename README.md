...
![Coverage badge](https://badge.cs329.click/badge/qbarger/jwtpizzacoverage)
[![CI Pipeline](https://github.com/qbarger/jwt-pizza/actions/workflows/ci.yml/badge.svg)](https://github.com/qbarger/jwt-pizza/actions/workflows/ci.yml)
...
1. Fork this repository
   ...
   ```sh
   git clone https://github.com/qbarger/jwt-pizza.git
   ```
